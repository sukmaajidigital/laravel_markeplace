                        ...
                        <table class="table text-center">
                            ...
                            @if (EcommerceHelper::isCartEnabled())
                                <tr class="pr_add_to_cart">
                                    ...
                                    @foreach(Cart::instance('compare')->content() as $item)
                                        <td class="row_btn"><a href="#" class="btn btn-rounded btn-sm add-to-cart-button" data-id="{{ $item->id }}" data-url="{{ route('public.cart.add-to-cart') }}"><i class="far fa-shopping-bag mr-5"></i>{{ __('Add To Cart') }}</a></td>
                                    @endforeach
                                </tr>
                            @endif
